...
def parse_arguments():
    ...
    parser.add_argument('--bf_algorithm', choices=['vsharp', 'pdf'], default='pdf',
                        help='Background field removal algorithm')
    return parser.parse_args()

def main():
    print("[INFO] Starting QSM-TV algorithm...")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Run QSMxT with TV
        print("[INFO] Running QSMxT with Total Variation...")
        qsmxt_cmd = [
    ...
    print("[INFO] QSM-TV algorithm completed successfully!")
